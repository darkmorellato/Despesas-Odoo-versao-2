...
export const FileText: React.FC<IconComponentProps> = (props) => (
  <Icon {...props} path='<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline>' />
);

export const Menu: React.FC<IconComponentProps> = (props) => (
  <Icon {...props} path='<line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="18" x2="21" y2="18"></line>' />
);

export const ArrowUp: React.FC<IconComponentProps> = (props) => (
  <Icon {...props} path='<line x1="12" y1="19" x2="12" y2="5"></line><polyline points="5 12 12 5 19 12"></polyline>' />
);

export const ArrowDown: React.FC<IconComponentProps> = (props) => (
  <Icon {...props} path='<line x1="12" y1="5" x2="12" y2="19"></line><polyline points="19 12 12 19 5 12"></polyline>' />
);

export const ArrowUpDown: React.FC<IconComponentProps> = (props) => (
  <Icon {...props} path='<polyline points="7 15 12 20 17 15"></polyline><polyline points="7 9 12 4 17 9"></polyline>' />
);

export const Lock: React.FC<IconComponentProps> = (props) => (
  <Icon {...props} path='<rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path>' />
);

export const Mail: React.FC<IconComponentProps> = (props) => (
  <Icon {...props} path='<path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline>' />
);

export const Eye: React.FC<IconComponentProps> = (props) => (
  <Icon {...props} path='<path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle>' />
);

export const EyeOff: React.FC<IconComponentProps> = (props) => (
  <Icon {...props} path='<path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path><line x1="1" y1="1" x2="23" y2="23"></line>' />
);

export const LogOut: React.FC<IconComponentProps> = (props) => (
  <Icon {...props} path='<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line>' />
);

export const Shield: React.FC<IconComponentProps> = (props) => (
  <Icon {...props} path='<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path>' />
);

export const History: React.FC<IconComponentProps> = (props) => (
